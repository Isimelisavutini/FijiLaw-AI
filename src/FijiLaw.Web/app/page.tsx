...
export default function Home() {
  ...
  return <main className="siteShell">
    <header className="siteHeader"><a className="brand" href="#top">FijiLaw AI</a><nav className="navLinks"><a href="#services">Get help</a><a href="#legal-help">Legal areas</a><a href="#how-it-works">How it works</a><a href="#trust">Trust & safety</a></nav><a className="headerCta" href="#triage">Start assessment</a></header>
    ...
    <section className="trustSection" id="trust"><div><p className="eyebrow light">TRUST & SAFETY</p><h2>Built to assist people, not invent law.</h2></div><div className="trustGrid"><article><strong>Verified sources</strong><p>Legal authorities are surfaced with official-source links rather than generated from memory alone.</p></article><article><strong>Human escalation</strong><p>Higher-risk matters can be flagged for review by a qualified legal practitioner.</p></article><article><strong>Traceable assessments</strong><p>Each assessment receives a reference identifier to support future audit and case workflows.</p></article><article><strong>Privacy-first design</strong><p>Users are prompted to avoid unnecessary sensitive information while secure case handling is developed.</p></article></div></section>

    <section className="languageSection"><p className="eyebrow">BUILT FOR FIJI</p><h2>Legal access should not depend on where you live or the language you are most comfortable using.</h2><div className="languagePills"><span>English</span><span>iTaukei</span><span>Fiji Hindi</span><span>More languages planned</span></div></section>
