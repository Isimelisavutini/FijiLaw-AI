...
export default function AccountPage() {
  ...
  return <main style={{maxWidth:760,margin:'0 auto',padding:'64px 24px',fontFamily:'Inter,system-ui,sans-serif',color:'#16231c'}}>
    ...
    <p style={{color:'#5c6b62',lineHeight:1.6}}>Free accounts can access public services. Paid memberships unlock the FijiLaw dashboard, saved legal matters and professional workflows. Paid dashboard access also requires a verified email address.</p>
